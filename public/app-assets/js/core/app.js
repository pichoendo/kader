    ...
    searchInputInputfield.on("keyup", function (e) {
        ...
        if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
            ...
            if (value != "") {
                ...
                $.getJSON(
                    assetPath + "data/" + $filename + ".json",
                    function (data) {
                        for (var i = 0; i < data.listItems.length; i++) {
                            // if current is bookmark then give class to star icon
                            // for laravel
                            if (
                                $("body").attr("data-framework") === "laravel"
                            ) {
                ...
                if (bookmark === true) {
                    ...
                    for (var i = 0; i < arrList.length; i++) {
                        ...
                        var iconName = "",
                            className = "";
                        if (
                            $(arrList[i].firstChild.firstChild).hasClass(
                                "feather"
                            )
                        ) {
                            var classString =
                                arrList[i].firstChild.firstChild.getAttribute(
                                    "class"
                                );
                            iconName = classString
                                .split("feather-")[1]
                                .split(" ")[0];
        ...
        function (e) {
            ...
            if ($(this).hasClass("text-warning")) {
                ...
                var $url = $(this).parent()[0].href,
                    ...
                    $listItemDropdown = "",
                    iconName =
                        $(this).parent()[0].firstChild.firstChild.dataset.icon;
                if (
                    $($(this).parent()[0].firstChild.firstChild).hasClass(
                        "feather"
                    )
                ) {
