    ...
    (function (a, e, t) {
        ...
        if (
            ...
            t(a).on("load", function () {
                ...
                var l = t(".chartjs"),
                    c = l.children("canvas").attr("height"),
                    d = t(".main-menu");
                if (
                    (l.css("height", c),
                ...
                t(".custom-file-input").on("change", function (a) {
                    t(this)
                        .siblings(".custom-file-label")
                        .html(a.target.files[0].name);
                }),
            ...
            var i;
            "rtl" == t("html").data("textdirection") && (i = !0);
            var l = e.querySelector(".drag-target"),
                c = "panright",
                d = "panleft";
            if (
                (!0 === i && ((c = "panleft"), (d = "panright")),
                t(l).length > 0)
            )
                new Hammer(l).on(c, function (a) {
        ...
        if (
            ...
            t(".carousel").carousel({ interval: 2e3 }),
            t(a).resize(function () {
            ...
            (g.on("click", function (a) {
                ...
                for (var o = 0; o < e.length; o++) {
                    ...
                    if (t(e[o].firstChild.firstChild).hasClass("feather")) {
                        ...
                        (r = l.split("feather-")[1].split(" ")[0]),
                            (i = l.split("feather-")[1].split(" ")[1]);
                    }
                    s +=
                        ...
                        feather.icons[r].toSvg({ class: "mr-75 " + i }) +
                        "<span>" +
                        e[o].firstChild.dataset.originalTitle +
                        "</span></div>" +
                ...
                if (
                    ...
                    if (
                        ...
                        var o = "",
                            ...
                            c = "",
                            d =
                                '<li class="d-flex align-items-center"><a href="javascript:void(0)"><h6 class="section-label mt-75 mb-0">Pages</h6></a></li>',
                            h = "",
                            u = "",
                            f = 0;
                        t.getJSON(r + "data/" + p + ".json", function (a) {
                            for (var m = 0; m < a.listItems.length; m++) {
                                if (
                                    ...
                                    h = feather.icons.star.toSvg({
                                        class: "bookmark-icon float-right" + s,
                                    });
                                }
                                0 ==
                                    a.listItems[m].name
                            ...
                            (u = t(".main-search-list-defaultlist").html()),
                                ...
                                (l = d.concat(o, i, u)),
                                t("ul.search-list").html(l),
                                (c = o.concat(i)),
                                t("ul.search-list-bookmark").html(c);
                        });
                    } else if (!0 === n) {
                        for (
                            var m = t("ul.nav.navbar-nav.bookmark-icons li"),
                                v = "",
                                g = 0;
                            g < m.length;
                            g++
                            ...
                            var C = "";
                            if (
                                t(m[g].firstChild.firstChild).hasClass(
                                    "feather"
                                )
                            ) {
                                var I =
                                    m[g].firstChild.firstChild.getAttribute(
                                        "class"
                                    );
                            ...
                            v +=
                                ...
                                m[g].firstChild.href +
                                '><div class="d-flex justify-content-start align-items-center">' +
                                feather.icons[C].toSvg({ class: "mr-75 " }) +
                                "<span>" +
                                m[g].firstChild.dataset.originalTitle +
                                "</span></div>" +
                                feather.icons.star.toSvg({
                                    class: "text-warning bookmark-icon float-right",
                                }) +
                ...
                function (a) {
                    if (
                        ...
                        for (
                            ...
                            e[s].firstChild.dataset.originalTitle ==
                        ...
                        (n =
                            ...
                            r +
                            '">' +
                            feather.icons[i].toSvg({ class: "ficon" }) +
                            "</a></li>"),
        ...
        t(".nav-link-style").on("click", function () {
            ...
            (e =
                ...
                (function (a) {
                    ...
                    t("input:radio[data-layout=" + i + "]").length > 0 &&
                        setTimeout(function () {
                            t("input:radio[data-layout=" + i + "]").prop(
                                "checked",
                                !0
                            );
                        });
        ...
        jQuery.validator.setDefaults({
            ...
            errorPlacement: function (a, e) {
                ...
                "checkbox" === e.attr("type")
                    ...
                    : e.hasClass("custom-control-input")
